...
related_files: settings.md, codex.md, claude-code.md, google-gemini.md, ../adrs/ADR-0000-governanca-do-harness-documental.md
...
- [Política do ambiente e do assistente](settings.md) - matriz agnostica de menor privilegio, Git governado e operacoes proibidas.

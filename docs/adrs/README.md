...
keywords: adr, decisoes, arquitetura, indice, orquestrador, standards, gemini, antigravity
related_files: ADR-0000-governanca-do-harness-documental.md, ../agents/AgentOrchestrator.md, ../agents/standards/README.md, ../settings/google-gemini.md, ../templates/TPL-00004-adr.md
...
| --- | --- | --- | --- |
| [ADR-0000](ADR-0000-governanca-do-harness-documental.md) | `v1.2`: governança, adapters Google, orquestrador inicial e biblioteca portátil de standards | Accepted | Governança |
